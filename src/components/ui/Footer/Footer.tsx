        ...
        <footer className="footer">
            <Container>
                <Group size={2}>
                    ...
                    >
                        <div className="footer__block__title">
                            <Link to="/">VietAI Research</Link>
                        </div>
                        <div className="footer__block__item">
                            <Link to="https://vietai.org/" target={'_blank'}>About</Link>
                        </div>
                        <div className="footer__block__item">
                            <Link to="https://vietai.org/contact/" target={'_blank'}>Contact</Link>
                        </div>
                    </Block>
                ...
                <Group size={3}>
                    ...
                    >
                        <a
                            href="https://github.com/vietai" target={'_blank'}
                        ...
                        <a
                            href="https://www.facebook.com/vietaipublic" target={'_blank'}
                            className="footer__block__item__social"
                        >
                            <svg
                                viewBox="0 0 128 128"
                        ...
                        <a
                            href="https://twitter.com/vietaiorg" target={'_blank'}
                            className="footer__block__item__social"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a
                            ...
                            className="footer__block__item__social"
                            href="https://www.linkedin.com/company/vietai" target={'_blank'}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                    ...
                    <Block
                        ...
                        className="footer__block"
                    >
                        <div>Copyright © 2022 VietAI • All Rights Reserved</div>
                    </Block>
                </Group>
            </Container>
        </footer>
